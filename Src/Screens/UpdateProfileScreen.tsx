...
import { View, Text, TouchableOpacity, ScrollView, StyleSheet, Image, TextInput, StatusBar, Alert } from 'react-native';
...
export default function UpdateProfileScreen({ route, navigation }: Props) {
  ...
  const handleChangeImage = () => {
    Alert.alert('Change Avatar', 'Opening device gallery...', [
      { text: 'Cancel', style: 'cancel' },
      { text: 'Select Image', onPress: () => console.log('Gallery launched') }
    ]);
  };
